...
// In the first example with a non-readonly property, 'price' can be freely modified.
// In the second example with a read-only property, any attempt to modify 'productId' results in a TypeScript error,
// ensuring that the property remains constant.